...
<table class="table table-striped">
    ...
    <tbody>
        ...
        <tr class="text-center">
            ...
            <td><input type="date" value="{{$item->fecha_nacimiento}}" readonly /></td>
            <td>{{$item->telefono}}</td>
            <td><a class="btn btn-warning" href="modificarPaciente.php?DNI={{$item->DNI}}" role="button">
            ...
            <td><a class="btn btn-danger" href="eliminarPaciente.php?DNI={{$item->DNI}}" onclick='return confirmacion4()' role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
