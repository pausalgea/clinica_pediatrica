...
<form  method="POST"  action="modificarConsulta.php"> 
    <div class="container">
    <div class="row">
        <div class="col">
            <label class="text-left" for="nombre">Id de consulta </label> 
            <input type="text" class="form-control" name="consultaAModificar" value=<?php echo e($id_consulta); ?> placeholder=<?php echo e($id_consulta); ?> readonly>
        </div>
    </div>
    <div class="row">
        <div class="col">  
